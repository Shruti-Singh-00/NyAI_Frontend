    ...
    <Layout title={"Drafting-2"}>
      <div className="drafting2 container-sm">
        <div className="row  d-md-flex flex-md-row flex-column-reverse">
          <div className="col sampleDiv">
            <div className="sample me-5">
              <center>
              ...
              <p>
                ...
                successors , assigns , representatives etc. Whereas the Lessor
                /Owner is the owner and in possession of the property No:
                <b>{property ? property : "(Property Number)"}</b> and has agreed to
                let out the one office Room, one Toilet & Bathroom Set on said
                property, to the Lessee/Tenant and the Lessee/Tenant has agreed
                to take the same on rent of{" "}
                ...
                <br />
                2.That the Tenant /Lessee shall not sub–let any part of the
                above said premises to anyone else under any circumstances
                ...
                demised premises and shall not do any illegal activities in the
                said demised premises.
                <br />
                4.That this Lease is granted for a period of{" "}
                <b>{period ? period : "( Time Duration )"}</b> only commencing from{" "}
                <b>{rentDate ? rentDate : "(date of rent commencing from)"}</b> and
                this lease can be extended further by both the parties with
                their mutual consent on the basis of prevailing rental value in
                the market.
                <br />
                5.That the Lessee shall pay Electricity & Water charge as per
                the proportionate consumption of the meter to the Lessor /Owner.
                <br />
                6.That the Tenant/Lessee shall not be entitled to make structure
                in the rented premises except the installation of temporary
                decoration, wooden partition/cabin, air – conditioners etc.
                ...
                inspection/general checking or to carry out the repair work, at
                any reasonable time.
                <br />
                ...
                <br />
                10.That the Tenant/Lessees shall carry on all day to day minor
                repairs at his/her own cost.
                <br />
                11.That this Agreement may be terminated before the expiry of
                this tenancy period by serving One month prior notice by either
                party for this intention .<br />
                12.That the Lessee shall use the above said premises for
                ...
                <br />
                15.That both the parties have read over and understood all the
                ...
                <b>{property ? property : "( Place Detail)"}</b> on this the{" "}
                <b>{aggrementDate ? aggrementDate : "( date of rent agreement )"}</b>
                year first above Mentioned in presents of the following
                Witnesses WITNESSES:
                <br />
                1.<b>{witness1 ? witness1 : "( Witness1 )"}</b>
                <br />
                2. <b>{witness1 ? witness1 : "( Witness2 )"}</b>
                <br />
